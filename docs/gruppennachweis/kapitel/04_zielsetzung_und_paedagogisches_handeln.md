...
Kapitel 4 ist die **Begründungsachse**, nicht die Bewertungsachse.

- Hier steht: **Hypothese -> Entscheidung -> Begründung -> Wirkindikator**.
- In [Kapitel 5.3](05_reflexion.md#53-evidenzlage-und-gegenhypothesen-je-entscheidung-e1e6) steht: **Wirkung, Evidenzurteil (A/B/C), Gegenhypothese, Nachweislücke**.

Damit gilt für dieses Kapitel die Entkopplungsregel:
...
Arbeitsgrundlage für die Verdichtung: [komprimierte_zielstruktur.md](../komprimierte_zielstruktur.md).
...
### Projektphasen als Rahmenstruktur
...
- **Pädagogische Zurückhaltung:** Die Projektleitung bleibt „unterstützend und unauffällig" im Hintergrund, wird sichtbar, wenn benötigt (Scaffolding).
  → Quelle: [docs/projektplan.md](../../projektplan.md) (Phase 2), [docs/entscheidungen/03_systemarchitektur_und_regulation.md](../../entscheidungen/03_systemarchitektur_und_regulation.md) (Scaffolding in formellen Situationen)
- **Operationalisierung von Partizipation** (nach Rahmenmodell „Prep-Planung"): Eine Aktivität gilt als partizipativ, wenn die Zielperson mindestens eine inhaltlich gestaltende Entscheidung trifft UND Rückmeldung eingeholt und berücksichtigt wird.
  → Quelle: [models/prep_planung.md](../../../models/prep_planung.md) (Schwelle Partizipation)

**Belegte Partizipationsereignisse:**

- Standort- und Gestaltungsideen (interner Standort, roter Mülleimer, Wahl des Spruchs, Beschriftung) stammen von X.
  → Quelle: [docs/tagebuch/04_tag_4.md](../../tagebuch/04_tag_4.md), [docs/tagebuch/05_tag_5.md](../../tagebuch/05_tag_5.md), [docs/tagebuch/06_tag_6.md](../../tagebuch/06_tag_6.md)
- Vorschlag zur Verwendung des Pfanderlöses für Projekt-Verbrauchsmaterialien.
  → Quelle: [docs/tagebuch/04_tag_4.md](../../tagebuch/04_tag_4.md)
- Eigenes Feedback wird erhoben und als eigene Quelle dokumentiert.
  → Quelle: [docs/feedback/*.md](../../feedback/01_feedback_zielperson.md), [meta/arbeitsregeln.md](../../../meta/arbeitsregeln.md) (Regeln 7, 8)
