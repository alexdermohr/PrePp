...
Statt "maximale Nachweisbarkeit" wird als Leitfrage gesetzt:

**Maximale Entscheidungsnachvollziehbarkeit bei gleicher Quellenstrenge.**
...
Die zentrale Matrix ist das Hauptartefakt, nicht Beifang:
...
- Kapitel 1 Thema
  Kernfunktion: Problem, Ziel, Relevanz (kurz)
  Nicht mehr tun: keine Detailrekonstruktion von H1-H11
- Kapitel 2 Kontext
  Kernfunktion: nachweisbarer Rahmen plus Kontextlimit
  Nicht mehr tun: kein Auffuellen epistemischer Leerstelle
- Kapitel 3 Menschen/ICF
...
- Kapitel 5 Reflexion
  ...
  Nicht mehr tun: keine erneute Massnahmenbegruendung
- Kapitel 6 Formalia/Anhang
  Kernfunktion: Nachweiswege, Apparat, Anhangstrennung
  Nicht mehr tun: keine inhaltliche Argumentation

## 4. Entkopplungsregeln (gegen Redundanz)

1. **Hypothese beschreiben:** in Kapitel 4.
2. **Hypothese bewerten:** in Kapitel 5.
3. **Entscheidung begruenden:** in Kapitel 4.
4. **Entscheidung bewerten:** in Kapitel 5.3.
...
1. Methodik (A/B/C, Kontrastpruefung, Kausalitaetsgrenze)
2. Zielkurzbilanz T1-T5 (maximal eine Zeile pro Ziel)
3. Zentrale Matrix E1-E6 (Hauptteil)
4. Hypothesenstatus H1-H11 (Kurzuebersicht)
5. Schlussfolgerungen + offene Punkte
